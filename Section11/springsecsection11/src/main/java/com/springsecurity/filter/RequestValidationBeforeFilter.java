...
public class RequestValidationBeforeFilter implements Filter {
    ...
    /**
     * This filter will check if we have "test" in the email in the basic authentication way.
     * If it contains "test" then we will set the status of the response as 400
     *
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        //These filters are like chain e.g. cors run , then csrf, then this custom filer then the basic authentication
